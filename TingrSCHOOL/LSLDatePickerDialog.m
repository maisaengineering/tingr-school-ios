...
- (UIView*)createContainerView{
    CGSize screenSize = [self countScreenSize];
    CGSize dialogSize = CGSizeMake(280,246);
    ...
    datePickerFrame.size.width = 280;
...
- (void)addButtonsToView:(UIView*)container {
    ...
    cancelButton.frame = CGRectMake(10,5,30,30);
    ...
    doneButton.frame = CGRectMake(container.frame.size.width-40,5,30,30);
    ...
    [doneButton setImage:[UIImage imageNamed:@"tick"] forState:UIControlStateNormal];
    [container addSubview:doneButton];
    self.doneButton = doneButton;
    
    UIImageView *lineImage2 = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"line_icon.png"]];
    [lineImage2 setFrame:CGRectMake(0, 35.5, container.frame.size.width, 0.5f)];
    [container addSubview:lineImage2];
